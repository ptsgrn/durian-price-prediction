...
<P class="font-loop">
	...
	ซึ่งเป็นค่าเปอร์เซ็นต์ความคลาดเคลื่อนและกำลังสองความคลาดเคลื่อนต่ำที่สุดเท่ากับ 9.70% และ 11.84
	ตามลำดับ จึงมีความถูกต้องและเหมาะสมมากที่สุดในการพยากรณ์ราคาทุเรียน
	...
	ข้อมูลอนุกรมราคาทุเรียนหมอนทองอยู่ในระดับยอมรับค่าแม่นยำได้ประมาณ 85% - 90%
	เหมาะสมที่จะนำไปพยากรณ์ราคาทุเรียนในอนาคตผลการหาตัวแบบพยากรณ์ที่ใช้เกณฑ์ค่า MAPE และค่า RMSE พบว่า
	วิธีการถดถอยแบบโพลิโนเมียล มีค่าพยากรณ์เข้าใกล้เคียงข้อมูลจริงมากที่สุด และมีค่า MAPE และค่า RMSE
	ซึ่งเป็นค่าเปอร์เซ็นต์ความคลาดเคลื่อนและกำลังสองความคลาดเคลื่อนต่ำที่สุดเท่ากับ 9.70% และ 11.84
	ตามลำดับ จึงมีความถูกต้องและเหมาะสมมากที่สุดในการพยากรณ์ราคาทุเรียน
	รองลงมาได้แก่วิธีการถดถอยเชิงเส้นอย่างง่าย ซึ่งมีความคลาดเคลื่อนสูง
	เนื่องจากกราฟราคาทุเรียนไม่สอดคล้องกับสมการเส้นตรง แสดงให้เห็นว่า
	ข้อมูลอนุกรมราคาทุเรียนหมอนทองอยู่ในระดับยอมรับค่าแม่นยำได้ประมาณ 85% - 90%
	เหมาะสมที่จะนำไปพยากรณ์ราคาทุเรียนในอนาคต
</P>
